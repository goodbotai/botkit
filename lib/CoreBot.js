...
function Botkit(configuration) {
      ...
      redis
          ...
          .then(response => {
              if (response) {
                  ...
                  throw new Error('This user does not have a saved conversation');
              }
          })
  ...
  botkit.storeConversation = function(message) {
      ...
      // TODO:
      redis.hset('botkit:storage:conversations', message.user, JSON.stringify(x));
  };
